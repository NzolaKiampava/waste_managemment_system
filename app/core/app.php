...
Class App
{
	...
	public function __construct()
	{
		...
		{ 
			...
			if(method_exists($this->controller, $url[1]) && is_callable([$this->controller, $url[1]]))                   //if exists this method on url[1], is_callback() check for access type method, if is private, protected or public
			{
				$this->method = $url[1];
				unset($url[1]);
			}
