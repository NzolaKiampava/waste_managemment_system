        ...
        -->
          ...
          <div class="form-outline mb-4">
            <input type="text" id="form3Example3" class="form-control form-control-lg"
              placeholder="Enter a valid username" name="name" value="<?= isset($_POST['name']) ? $_POST['name'] : '';?>" />
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            ...
            <p class="small fw-bold mt-2 pt-1 mb-0">Already have an account? <a href="<?=ROOT?>login" class="link-danger">Login</a></p>
          </div>
