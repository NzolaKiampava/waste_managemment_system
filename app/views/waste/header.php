...
<?php
   $image = 'uploads/user4-128x128.jpg';
   if(isset($user_data)){
        ...
        <div class="container-fluid"><a class="navbar-brand" href="#"><img src="<?=ASSETS . THEME?>/assets/img/icons/logo.png" alt="" width="169" /></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto ms-lg-4 ms-xl-7 border-bottom border-lg-bottom-0 pt-2 pt-lg-0">
              ...
              <li class="nav-item"><a class="nav-link fw-medium" href="#">Carros</a></li>
              <li class="nav-item"><a class="nav-link fw-medium" href="#">AcessarMapa </a></li>
              <li class="nav-item"><a class="nav-link fw-medium" href="#">LocalizarBalde</a></li>
            </ul>
            ...
            <form class="d-flex py-3 py-lg-0">
               ...
               <?php if(isset($data['user_data'])):?>
                  <a class="btn btn-link text-1000 fw-medium order-1 order-lg-0 me-lg-2" href="<?=ROOT?>logout" role="button">LogOut</a>
               <?php else: ?>
              <a class="btn btn-link text-1000 fw-medium order-1 order-lg-0 me-lg-2" href="<?=ROOT?>login" role="button">LogIn</a><?php endif; ?><?php if(isset($data['user_data']) && $data['user_data']->rank == "Administrador"):?><a class="btn btn-info order-0 me-1" href="<?=ROOT?>admin" role="button">Entrar</a>
