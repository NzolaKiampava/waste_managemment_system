...
<style>
  .d<?php $this->view("empresas/header", $data);?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Perfil da Empresa</li>
      </ol>
    </section>
        ...
        <div id="myform" class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img style="height:100px; width:100px;" class="profile-user-img img-responsive img-circle" ondragover="handle_drap_and_drop(event)" ondrop="handle_drap_and_drop(event)" ondragleave="handle_drap_and_drop(event)" src="<?=ROOT.$image?>" alt="User profile picture">

              <h3 class="profile-username text-center"><?=$user_data->empresa?></h3>

              <p class="text-muted text-center"><?=$user_data->email?></p>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Criou em</b> <a class="pull-right"><?=date('M d, Y', strtotime($user_data->created_at))?></a>
                </li>
                <li class="list-group-item">
                  <b>NIF</b> <a class="pull-right"><?=$user_data->nif?></a>
                </li>
              </ul>
                ...
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="name" value="<?=$user_data->empresa?>" id="inputName" placeholder="Nome">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="nif" value="<?=$user_data->nif?>">
                      </div>
                    </div>
                    <!-- /.input group -->
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="telefone" value="<?=$user_data->telefone?>">
                      </div>
                    </div>
                    <!-- /.input group -->
                  </div>
  ...
  function upload_profile_image(files){ //files is an array
    ...
    ajax.onload = function(){
        ...
        if (ajax.readyState == 4 || ajax.status == 200) {
            ...
            window.location = "<?=ROOT?>empresas/profile";
            change_image_button.disabled = false;
    ...
    ajax.open("POST", "<?=ROOT?>ajax_upload_profile_pic/upload_logo_empresa", true);
    ajax.send(myform);
